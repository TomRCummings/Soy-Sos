...
static void init_idt() {
    ...
    idt_set_entry(0xA, (uint32_t)&_isr10, 0x8, 1, 0, 0, 0xF);
    idt_set_entry(0xB, (uint32_t)&_isr11, 0x8, 1, 0, 0, 0xF);
    idt_set_entry(0xC, (uint32_t)&_isr12, 0x8, 1, 0, 0, 0xF);
    idt_set_entry(0xD, (uint32_t)&_isr13, 0x8, 1, 0, 0, 0xF);
    idt_set_entry(0xE, (uint32_t)&_isr14, 0x8, 1, 0, 0, 0xF);
    idt_set_entry(0xF, (uint32_t)&_isr15, 0x8, 1, 0, 0, 0xF);
    idt_set_entry(0x10, (uint32_t)&_isr16, 0x8, 1, 0, 0, 0xF);
    idt_set_entry(0x11, (uint32_t)&_isr17, 0x8, 1, 0, 0, 0xF);
    idt_set_entry(0x12, (uint32_t)&_isr18, 0x8, 1, 0, 0, 0xF);
    idt_set_entry(0x13, (uint32_t)&_isr19, 0x8, 1, 0, 0, 0xF);
    idt_set_entry(0x14, (uint32_t)&_isr20, 0x8, 1, 0, 0, 0xF);
    idt_set_entry(0x1E, (uint32_t)&_isr30, 0x8, 1, 0, 0, 0xF);
    //IRQs
